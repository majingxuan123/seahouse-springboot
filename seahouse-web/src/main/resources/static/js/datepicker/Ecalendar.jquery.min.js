$.fn.ECalendar = function (A) {
    ...
    A = $.extend(f, A);
    var b = $(this), z, q, j, t, n, v, r, H, k, L, m, i, K, h, o, d, D, B, g, e, u = A.step, c, a, E, s = false, l, C,
        w = A.format ? A.format : "yyyy-mm-dd hh:ii", F = A.format ? A.format : "yyyy-mm-dd",
    ...
    b.click(function (O) {
        ...
        var N = b.position();
        if (x / 2 < P) {
            z.css({"left": N.left + A.offset[0], "top": N.top - A.offset[1] - z.height() - 1,})
        } else {
            z.css({"left": N.left + A.offset[0], "top": N.top + b.outerHeight() + A.offset[1],})
        }
        ...
        if (c) {
            ...
            if (c[0].tagName == "LI") {
                if (Math.abs(e) > 1 || Math.abs(g) > 1) {
                    ...
                    l.css({"transform": "rotate(" + (P - 90) + "deg)"})
                }
            } else {
                var R = e;
                var M = E + R;
